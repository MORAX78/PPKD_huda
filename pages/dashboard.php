                ...
                <div class="row align-items-center">
                    ...
                    <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                            ...
                            <h4 class="card-title">
                                Rp. <?php echo number_format($dataHarian['omzet']) ?>
                            </h4>
                            <p class="card-subtitle">
                                Total Transaksi <?php echo number_format($dataHarian['total']) ?>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                            ...
                            <h4 class="card-title">Rp. <?php echo $mingguan['omzet'] ?></h4>
                            <p class="card-subtotal">
                                Total Transaksi : <?php echo $mingguan['total'] ?>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                            ...
                            <h4 class="card-title"><?php echo $bulanan['omzet'] ?></h4>
                            <p class="card-subtotal">
                                Total Transaksi : <?php echo $bulanan['total'] ?>
                            </p>
                        </div>
                    </div>
                </div>
