...
<body onload="printAndClose()">
    <div class="struk">
            ...
            <?php foreach ($dataOrderDetails as $item) : ?>
                <div class="item">
                    ...
                    <div class="item-detail">
                        <span><?php echo $item['qty'] ?> x <?php echo $item['order_price'] ?></span>
                        <span><?php echo $item['order_subtotal'] ?></span>
                    </div>
                </div>
            <?php endforeach ?>
        </div>
        ...
        <div class="struk-footer">
            <div class="row">
                <span>Total</span>
                <span>Rp. <?php echo $dataOrder['order_amount'] ?? '' ?></span>
            </div>
            <div class="row">
                <span>Bayar</span>
                <span>Rp. <?php echo $dataOrder['order_pay'] ?? '' ?></span>
            </div>
            <div class="row">
                <span>Kembali</span>
                <span>Rp. <?php echo $dataOrder['order_change'] ?? '' ?></span>
            </div>
            <div class="divider"></div>
            <p>Terima Kasih :)</p>
        </div>
